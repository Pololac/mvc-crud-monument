        ...
        <div class="col-5">
            ...
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pays" name="pays" value="<?=htmlentities($_POST['pays']??'')?>"/>
                </div>
                <div class="form-group">
                    <label for="ville">Ville où il se trouve : </label>
                    <input type="text" class="form-control" id="ville" name="ville" value="<?=htmlentities($_POST['ville']??'')?>"/>
                </div>
                <div class="form-group">
                    <label for="nbVisitesAn">Nombre de visites annuelles : </label>
                    <input type="number" class="form-control" id="nbVisitesAn" name="nbVisitesAn" value="<?=htmlentities($_POST['nbVisitesAn']??'')?>"/>
                </div>    
